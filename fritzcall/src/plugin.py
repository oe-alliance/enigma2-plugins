...
$Author: michael $
$Revision: 1256 $
$Date: 2016-02-01 11:44:23 +0100 (Mon, 01 Feb 2016) $
$Id: plugin.py 1256 2016-02-01 10:44:23Z michael $
'''
...
class FritzAbout(Screen):
	...
	def __init__(self, session):
		...
		self["text"] = Label(
							...
							"$Author: michael $"[1:-2] + "\n" +
							"$Revision: 1256 $"[1:-2] + "\n" + 
							"$Date: 2016-02-01 11:44:23 +0100 (Mon, 01 Feb 2016) $"[1:23] + "\n"
							)
...
class FritzCallSetup(Screen, ConfigListScreen, HelpableScreen):
	...
	def setWindowTitle(self):
		# TRANSLATORS: this is a window title.
		self.setTitle(_("FritzCall Setup") + " (" + "$Revision: 1256 $"[1: - 1] + "$Date: 2016-02-01 11:44:23 +0100 (Mon, 01 Feb 2016) $"[7:23] + ")")
...
class FritzProtocol(LineReceiver): # pylint: disable=W0223
	def __init__(self):
		info("[FritzProtocol] " + "$Revision: 1256 $"[1:-1]	+ "$Date: 2016-02-01 11:44:23 +0100 (Mon, 01 Feb 2016) $"[7:23] + " starting")
		global mutedOnConnID
		mutedOnConnID = None
		self.number = '0'
		self.caller = None
