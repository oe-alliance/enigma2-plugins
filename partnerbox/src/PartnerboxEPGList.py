...
def Partnerbox_EPGList__init__(self, type=0, selChangedCB=None, timer = None, time_epoch = config.epgselction.prev_time_period.getValue(), overjump_empty = config.epgselction.overjump.value):
	baseEPGList__init__(self, type, selChangedCB, timer, time_epoch = config.epgselction.prev_time_period.getValue(), overjump_empty = config.epgselction.overjump.value)
