...
class RSConfig(ConfigListScreen, TitleScreen):
	...
	def __init__(self, session):
		...
		list.append(getConfigListEntry(_("Ignore download times:"), config.plugins.RSDownloader.ignore_time))
		list.append(getConfigListEntry(_("Allow downloading on monday:"), config.plugins.RSDownloader.download_monday))
		list.append(getConfigListEntry(_("Allow downloading on tuesday:"), config.plugins.RSDownloader.download_tuesday))
		list.append(getConfigListEntry(_("Allow downloading on wednesday:"), config.plugins.RSDownloader.download_wednesday))
		list.append(getConfigListEntry(_("Allow downloading on thursday:"), config.plugins.RSDownloader.download_thursday))
		list.append(getConfigListEntry(_("Allow downloading on friday:"), config.plugins.RSDownloader.download_friday))
		list.append(getConfigListEntry(_("Allow downloading on saturday:"), config.plugins.RSDownloader.download_saturday))
		list.append(getConfigListEntry(_("Allow downloading on sunday:"), config.plugins.RSDownloader.download_sunday))
