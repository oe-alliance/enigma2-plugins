...
class AdditionalWebScreen(WebScreen):
	def __init__(self, session, request):
		...
		from ..WebComponents.Sources.SatellitesList import SatellitesList
		self["SatellitesList"] = SatellitesList(func=SatellitesList.FETCH)

		from ..WebComponents.Sources.ServiceList import ServiceList
		...
		from ..WebComponents.Sources.ProtectionSettings import ProtectionSettings
