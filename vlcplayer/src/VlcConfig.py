...
class VLCServerConfig(Screen, ConfigListScreen):
	skin = """
		<screen name="VLCServerConfig" position="80,148" size="560,280" title="Edit VLC Server">
			...
			<ePixmap name="red"    position="0,240"   zPosition="4" size="140,40" pixmap="Nemesis.SkinSuite.Shared/key-red.png" transparent="1" alphatest="on" />
			<ePixmap name="green"  position="140,240" zPosition="4" size="140,40" pixmap="Nemesis.SkinSuite.Shared/key-green.png" transparent="1" alphatest="on" />
			<ePixmap name="yellow" position="280,240" zPosition="4" size="140,40" pixmap="Nemesis.SkinSuite.Shared/key-yellow.png" transparent="1" alphatest="on" />
			<ePixmap name="blue"   position="420,240" zPosition="4" size="140,40" pixmap="Nemesis.SkinSuite.Shared/key-blue.png" transparent="1" alphatest="on" />
